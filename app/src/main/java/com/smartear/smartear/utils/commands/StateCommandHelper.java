...
public class StateCommandHelper extends BaseCommandHelper {
    ...
    private static final VoiceCommand[] voiceCommands = new VoiceCommand[]{
            ...
            new VoiceCommand(new String[]{"didi", "vault", "jackson", "DD", "get me", "beady", "beedie", "beedy", "bee de", "taxi", "greedy", "greed he", "guidi", "heedy", "heed he", "keady", "keedy,", "leady", "lea di", "midi", "mi de", "mi di", "needy", "need e", "need he", "reedy", "seedy", "tweedie", "tweedy", "weedy"}, RecognizedState.DIDI),
